...
| Тесты (`pytest tests/ -q`) | ✅ 71 passed | [`tests/`](tests/) |
...
python -m pytest tests/ -q                            # ожидается: 71 passed
...
- 71 автотест: граф агента, LLM-адаптеры, CLI, протокол оценки, равенство признаков, пропуски погоды, отсечка обучения, верификатор, панель.
...
| 23.09.2026 | Панель показывает сохранённую ретроспективную оценку вместо пересчёта модели; 71 тест |
