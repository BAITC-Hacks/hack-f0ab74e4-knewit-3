"""Панель оператора ВЭС: граф выполнения агента, прогноз с диапазоном P10–P90,
...
st.caption("Шелекский коридор, Алматинская область · две турбины · горизонт 24–48 часов · "
           "вход — архивные прогнозные поля; время их исторической публикации не подтверждено")
